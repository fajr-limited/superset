...
# under the License.
"""Add pdf_template tables

Revision ID: 39c43d26a57b
Revises: d482d51c15ca
Create Date: 2025-03-05 22:55:48.876818

"""

# revision identifiers, used by Alembic.
revision = '39c43d26a57b'
...
def upgrade():
    ...
    op.create_table('pdf_template_user',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('pdf_template_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['pdf_template_id'], ['pdf_templates.id'], ondelete='CASCADE'),
...
def downgrade():
    ...
    op.alter_column('ab_view_menu', 'name',
               ...
               type_=sa.VARCHAR(length=255),
               existing_nullable=False)
    op.drop_table('pdf_template_user')
