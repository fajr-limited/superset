...
class AddFavoritePdfTemplateCommand(BaseCommand):
    def __init__(self, chart_id: int) -> None:
        self._chart_id = chart_id
        self._chart: Optional[PdfTemplate] = None

    @transaction(on_error=partial(on_error, reraise=PdfTemplateFaveError))
    def run(self) -> None:
        self.validate()
        return PdfTemplateDAO.add_favorite(self._chart)
