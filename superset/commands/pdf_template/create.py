...
class CreatePdfTemplateCommand(CreateMixin, BaseCommand):
    def __init__(self, data: dict[str, Any]):
        self._properties = data.copy()

    @transaction(on_error=partial(on_error, reraise=PdfTemplateCreateFailedError))
    def run(self) -> Model:
        self.validate()
        return PdfTemplateDAO.create(attributes=self._properties)
