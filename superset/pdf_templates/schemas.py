...
#
id_description = "The id of the pdf_template."
name_description = "The name of the pdf_template."
description_description = "A description of the pdf_template propose."
data_description = "The pdf_template data JSON that structures the PDF."
owners_description = (
    "Owner are users ids allowed to delete or change this pdf_template. "
    "If left empty you will be one of the owners of the pdf_template."
)
params_description = (
...
changed_on_description = "The ISO date that the pdf_template was last changed."
owners_name_description = "Name of an owner of the pdf_template."
tags_description = "Tags to be associated with the pdf_template"

openapi_spec_methods_override = {
    "get": {"get": {"summary": "Get a pdf_template detail information"}},
    "get_list": {
        "get": {
            "summary": "Get a list of pdf_templates",
            "description": "Gets a list of pdf_templates, use Rison or JSON query "
    ...
    "related": {
        "get": {
            "description": "Get a list of all possible owners for a pdf_template. "
...
class PdfTemplateEntityResponseSchema(Schema):
    """
    Schema for a pdf_template object
    """

    id = fields.Integer(metadata={"description": id_description})
    name = fields.String(metadata={"description": name_description})
    data = fields.String(metadata={"description": data_description})
...
class PdfTemplatePostSchema(Schema):
    """
    Schema to add a new pdf_template.
    """
...
class PdfTemplatePutSchema(Schema):
    """
    Schema to update or patch a pdf_template
    """
...
class PdfTemplateGetDatasourceObjectResponseSchema(Schema):
    label = fields.String(metadata={"description": "The name of the datasource"})
    value = fields.Nested(PdfTemplateGetDatasourceObjectDataResponseSchema)


class PdfTemplateGetDatasourceResponseSchema(Schema):
    count = fields.Integer(metadata={"description": "The total number of datasources"})
    result = fields.Nested(PdfTemplateGetDatasourceObjectResponseSchema)


class PdfTemplateCacheScreenshotResponseSchema(Schema):
    cache_key = fields.String(metadata={"description": "The cache key"})
    pdf_template_url = fields.String(metadata={"description": "The url to render the pdf_template"})
    image_url = fields.String(
        metadata={"description": "The url to fetch the screenshot"}
    )


class PdfTemplateDataColumnSchema(Schema):
...
class PdfTemplateDataAdhocMetricSchema(Schema):
    """
    ...
    column = fields.Nested(PdfTemplateDataColumnSchema)
...
class PdfTemplateDataAggregateConfigField(fields.Dict):
...
class PdfTemplateDataPostProcessingOperationOptionsSchema(Schema):
    pass


class PdfTemplateDataAggregateOptionsSchema(PdfTemplateDataPostProcessingOperationOptionsSchema):
    """
    ...
    aggregates = PdfTemplateDataAggregateConfigField()


class PdfTemplateDataRollingOptionsSchema(PdfTemplateDataPostProcessingOperationOptionsSchema):
    """
...
class PdfTemplateDataSelectOptionsSchema(PdfTemplateDataPostProcessingOperationOptionsSchema):
    """
...
class PdfTemplateDataSortOptionsSchema(PdfTemplateDataPostProcessingOperationOptionsSchema):
    """
    Sort operation config.
    """
...
class PdfTemplateDataContributionOptionsSchema(PdfTemplateDataPostProcessingOperationOptionsSchema):
    """
...
class PdfTemplateDataProphetOptionsSchema(PdfTemplateDataPostProcessingOperationOptionsSchema):
    """
...
class PdfTemplateDataBoxplotOptionsSchema(PdfTemplateDataPostProcessingOperationOptionsSchema):
    """
    ...
    metrics = fields.List(
        ...
        metadata={
            ...
            "`PdfTemplateDataAdhocMetricSchema` for the structure of ad-hoc metrics. "
...
class PdfTemplateDataPivotOptionsSchema(PdfTemplateDataPostProcessingOperationOptionsSchema):
    """
...
class PdfTemplateDataGeohashDecodeOptionsSchema(
    PdfTemplateDataPostProcessingOperationOptionsSchema
):
    """
...
class PdfTemplateDataGeohashEncodeOptionsSchema(
    PdfTemplateDataPostProcessingOperationOptionsSchema
):
    """
...
class PdfTemplateDataGeodeticParseOptionsSchema(
    PdfTemplateDataPostProcessingOperationOptionsSchema
):
    """
...
class PdfTemplateDataPostProcessingOperationSchema(Schema):
    ...
    options = fields.Dict(
        metadata={
            ...
            "For example, `PdfTemplateDataPostProcessingOperationOptions` specifies "
...
class PdfTemplateDataFilterSchema(Schema):
    col = fields.Raw(
        metadata={
...
class PdfTemplateDataExtrasSchema(Schema):
...
class PdfTemplateDataDatasourceSchema(Schema):
    description = "PdfTemplate datasource"
    id = fields.Integer(
...
# class PdfTemplateDataQueryObjectSchema(Schema):
#     class Meta:  # pylint: disable=too-few-public-methods
#         unknown = EXCLUDE

#     datasource = fields.Nested(PdfTemplateDataDatasourceSchema, allow_none=True)
#     result_type = fields.Enum(PdfTemplateDataResultType, by_value=True, allow_none=True)

#     annotation_layers = fields.List(
#         fields.Nested(AnnotationLayerSchema),
#         metadata={"description": "Annotation layers to apply to pdf_template"},
#         allow_none=True,
#     )
...
#         allow_none=True,
#     )
#     filters = fields.List(fields.Nested(PdfTemplateDataFilterSchema), allow_none=True)
...
#         fields.Nested(PdfTemplateDataPostProcessingOperationSchema, allow_none=True),
#         allow_none=True,
#         metadata={
...
# class PdfTemplateDataQueryContextSchema(Schema):
#     query_context_factory: QueryContextFactory | None = None
#     datasource = fields.Nested(PdfTemplateDataDatasourceSchema)
#     queries = fields.List(fields.Nested(PdfTemplateDataQueryObjectSchema))
...
#     result_type = fields.Enum(PdfTemplateDataResultType, by_value=True)
#     result_format = fields.Enum(PdfTemplateDataResultFormat, by_value=True)
...
class PdfTemplateDataResponseResult(Schema):
...
class PdfTemplateDataResponseSchema(Schema):
    result = fields.List(
        fields.Nested(PdfTemplateDataResponseResult),
        metadata={
...
class PdfTemplateDataAsyncResponseSchema(Schema):
...
class PdfTemplateFavStarResponseResult(Schema):
    id = fields.Integer(metadata={"description": "The PdfTemplate id"})
    value = fields.Boolean(metadata={"description": "The FaveStar value"})


class GetFavStarIdsSchema(Schema):
    result = fields.List(
        fields.Nested(PdfTemplateFavStarResponseResult),
        metadata={
            "description": "A list of results for each corresponding pdf_template in the request"  # noqa: E501
        },
    )


class ImportV1PdfTemplateSchema(Schema):
...
class PdfTemplateCacheWarmUpRequestSchema(Schema):
    pdf_template_id = fields.Integer(
        required=True,
        metadata={"description": "The ID of the pdf_template to warm up cache for"},
    )
...
class PdfTemplateCacheWarmUpResponseSingleSchema(Schema):
    pdf_template_id = fields.Integer(
        metadata={"description": "The ID of the pdf_template the status belongs to"}
    )
    viz_error = fields.String(
        metadata={"description": "Error that occurred when warming cache for pdf_template"}
    )
...
class PdfTemplateCacheWarmUpResponseSchema(Schema):
    result = fields.List(
        fields.Nested(PdfTemplateCacheWarmUpResponseSingleSchema),
        metadata={
            "description": "A list of each pdf_template's warmup status and errors if any"
        },
    )
...
CHART_SCHEMAS = (
    ...
    PdfTemplateCacheWarmUpResponseSchema,
    # PdfTemplateDataQueryContextSchema,
    PdfTemplateDataResponseSchema,
    PdfTemplateDataAsyncResponseSchema,
    # TODO: These should optimally be included in the QueryContext schema as an `anyOf`
    #  in PdfTemplateDataPostProcessingOperation.options, but since `anyOf` is not
    #  by Marshmallow<3, this is not currently possible.
    PdfTemplateDataAdhocMetricSchema,
    PdfTemplateDataAggregateOptionsSchema,
    PdfTemplateDataContributionOptionsSchema,
    PdfTemplateDataProphetOptionsSchema,
    PdfTemplateDataBoxplotOptionsSchema,
    PdfTemplateDataPivotOptionsSchema,
    PdfTemplateDataRollingOptionsSchema,
    PdfTemplateDataSelectOptionsSchema,
    PdfTemplateDataSortOptionsSchema,
    PdfTemplateDataGeohashDecodeOptionsSchema,
    PdfTemplateDataGeohashEncodeOptionsSchema,
    PdfTemplateDataGeodeticParseOptionsSchema,
    PdfTemplateEntityResponseSchema,
    PdfTemplateGetDatasourceResponseSchema,
    PdfTemplateCacheScreenshotResponseSchema,
    GetFavStarIdsSchema,
)
