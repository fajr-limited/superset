...
/**
 * Legacy queried data for pdf_templates. List of arbitrary dictionaries generated
 * by `viz.py`.
 * TODO: clean this up when all pdf_templates have been migrated to v1 API.
 */
export type LegacyQueryData = PlainObject;

/**
 * Ambiguous query data type. Reserved for the generic QueryFormData.
 * Don't use this for a specific pdf_template (since you know which API it uses already).
 */
export type QueryData = LegacyQueryData ;
