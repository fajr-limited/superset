...
export type PreTransformProps = TransformFunction<PdfTemplateProps, PdfTemplateProps>;
export type TransformProps<Props extends PdfTemplateProps = PdfTemplateProps> =
