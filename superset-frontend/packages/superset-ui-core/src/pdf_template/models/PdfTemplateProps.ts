...
// TODO: more specific typing for these fields of PdfTemplateProps
...
type PdfTemplatePropsSelector = (c: PdfTemplatePropsConfig) => PdfTemplateProps;

/** Optional field for event handlers, renderers */
type Hooks = {
  /**
   * sync active filters between pdf_template and dashboard, "add" actually
...
/**
 * Preferred format for PdfTemplateProps config
 */
export interface PdfTemplatePropsConfig {
  annotationData?: AnnotationData;
  /** Datasource metadata */
  datasource?: SnakeCaseDatasource;
  initialValues?: DataRecordFilters;
  /** Main configuration of the pdf_template */
  ...
  /** PdfTemplate width */
  width?: number;
  /** Own pdf_template state that saved in dashboard */
  ownState?: JsonObject;
  /** Filter state that saved in dashboard */
  filterState?: FilterState;
  /** Legend state */
  legendState?: LegendState;
  /** Set of actual behaviors that this instance of pdf_template should use */
  behaviors?: Behavior[];
  /** PdfTemplate display settings related to current view context */
  displaySettings?: JsonObject;
  /** Application section of the pdf_template on the screen (in what components/screen it placed) */
  appSection?: AppSection;
  /** is the pdf_template refreshing its contents */
...
export default class PdfTemplateProps<FormData extends RawFormData = RawFormData> {
  static createSelector: () => PdfTemplatePropsSelector;
  ...
  constructor(config: PdfTemplatePropsConfig & { formData?: FormData } = {}) {
    const {
      annotationData = {},
      datasource = {},
...
PdfTemplateProps.createSelector = function create(): PdfTemplatePropsSelector {
  return createSelector(
    (input: PdfTemplatePropsConfig) => input.annotationData,
