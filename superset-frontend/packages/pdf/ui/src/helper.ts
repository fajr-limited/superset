...
import { RULER_HEIGHT } from '@pdfme/ui/src/constants.js';

GlobalWorkerOptions.workerSrc = '/static/assets/pdf/pdf.worker.min.mjs'; // `https://cdn.jsdelivr.net/npm/pdfjs-dist@${version}/build/pdf.worker.min.mjs`;
