...
import { I18nContext, FontContext, PluginsRegistry, OptionsContext } from '@pdfme/ui/src/contexts';
import { i18n, getDict } from '@pdfme/ui/src/i18n';
import { defaultTheme } from '@pdfme/ui/src/theme';
