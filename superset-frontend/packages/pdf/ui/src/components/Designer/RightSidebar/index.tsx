...
import ListView from '@pdfme/ui/src/components/Designer/RightSidebar/ListView';
import DetailView from '@pdfme/ui/src/components/Designer/RightSidebar/DetailView';
