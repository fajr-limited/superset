...
import { RIGHT_SIDEBAR_WIDTH } from '@pdfme/ui/src/constants';
import { I18nContext } from '@pdfme/ui/src/contexts';
import { getSidebarContentHeight } from '@pdfme/ui/src/helper';
import { theme, Input, Typography, Divider, Button } from 'antd';
import SelectableSortableContainer from '@pdfme/ui/src/components/Designer/RightSidebar/ListView/SelectableSortableContainer';
