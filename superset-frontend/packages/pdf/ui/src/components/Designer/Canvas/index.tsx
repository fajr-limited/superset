...
import { PluginsRegistry } from '@pdfme/ui/src/contexts';
import { X } from 'lucide-react';
import { RULER_HEIGHT, RIGHT_SIDEBAR_WIDTH } from '@pdfme/ui/src/constants';
import { usePrevious } from '@pdfme/ui/src/hooks';
import { uuid, round, flatten } from '@pdfme/ui/src/helper';
import Paper from '@pdfme/ui/src/components/Paper';
import Renderer from '@pdfme/ui/src/components/Renderer';
import Selecto from '@pdfme/ui/src/components/Designer/Canvas/Selecto';
import Moveable from '@pdfme/ui/src/components/Designer/Canvas/Moveable';
import Guides from '@pdfme/ui/src/components/Designer/Canvas/Guides';
import Mask from '@pdfme/ui/src/components/Designer/Canvas/Mask';
import Padding from '@pdfme/ui/src/components/Designer/Canvas/Padding';
import StaticSchema from '@pdfme/ui/src/components/StaticSchema';
